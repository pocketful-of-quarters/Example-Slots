...
namespace CSFramework {
   ...
   //         FetchSymbols(reference);
        ...
        //private DatabaseReference SetFirebase () {
        //    // Set up the Editor before calling into the realtime database.
        //    FirebaseApp.DefaultInstance.SetEditorDatabaseUrl("https://slot-invader.firebaseio.com/");
        ...
        //private void FetchSymbols (DatabaseReference reference) {
        //    Symbol symbolMold = GetComponentsInChildren<Symbol>()[0];
        //    Debug.Log(symbolMold.name);
        ...
        //                Debug.Log(child.Key);
        //                //Symbol aSymbol = Util.InstantiateAt<Symbol>(symbolMold, transform);
                        
        //                //aSymbol.frequency = child.Child("frequency").GetValue(false);
        //                ////aSymbol.matchType = child.Child("frequency").GetValue(false);
        //                //aSymbol.minCountPerReel = child.Child("minCountPerReel").GetValue(false);
        //                //aSymbol.name = child.Child("name").GetValue(false);
        //                //aSymbol.rowSize = child.Child("rowSize").GetValue(false);
        //            }
        //        }
        //    });
