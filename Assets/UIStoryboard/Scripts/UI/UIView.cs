...
namespace UIToolkit.UI {
	public class UIView : MonoBehaviour {
        ...
        [HideInInspector] public RectTransform safeArea {
            get {
                return (RectTransform)viewContent.transform.Find("SafeArea");
            }
        }
		...
		public virtual void Awake() {
            ...
            //if (UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPhoneX || Constants.SIMULATE_IPHONE_X) {
            //    topOffset = -88f;
            //    bottomOffset = 58f;
            //}
